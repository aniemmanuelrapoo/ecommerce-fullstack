				...
				<div class="box overflow-hidden pull-up">
					<div class="box-body">							
						<div class="icon bg-primary-light rounded w-60 h-60">
							<i class="text-primary mr-0 font-size-24"><iconify-icon icon="mdi:account-multiple"></iconify-icon></i>
						</div>
						<div>
				...
				<div class="box overflow-hidden pull-up">
					<div class="box-body">							
						<div class="icon bg-warning-light rounded w-60 h-60">
							<i class="text-warning mr-0 font-size-24"><iconify-icon icon="mdi:car"></iconify-icon></i>
						</div>
						<div>
				...
				<div class="box overflow-hidden pull-up">
					<div class="box-body">							
						<div class="icon bg-info-light rounded w-60 h-60">
							<i class="text-info mr-0 font-size-24"><iconify-icon icon="mdi:sale"></iconify-icon></i>
						</div>
						<div>
				...
				<div class="box overflow-hidden pull-up">
					<div class="box-body">							
						<div class="icon bg-danger-light rounded w-60 h-60">
							<i class="text-danger mr-0 font-size-24"><iconify-icon icon="mdi:phone-incoming"></iconify-icon></i>
						</div>
						<div>
				...
				<div class="box overflow-hidden pull-up">
					<div class="box-body">							
						<div class="icon bg-success-light rounded w-60 h-60">
							<i class="text-success mr-0 font-size-24"><iconify-icon icon="mdi:phone-outgoing"></iconify-icon></i>
						</div>
						<div>
				...
				<div class="box overflow-hidden pull-up">
					<div class="box-body">							
						<div class="icon bg-light rounded w-60 h-60">
							<i class="text-white mr-0 font-size-24"><iconify-icon icon="mdi:chart-line"></iconify-icon></i>
						</div>
						<div>
